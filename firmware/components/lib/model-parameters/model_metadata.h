...
#define EI_CLASSIFIER_PROJECT_ID                 867328
#define EI_CLASSIFIER_PROJECT_OWNER              "vuhamthieu"
#define EI_CLASSIFIER_PROJECT_NAME               "tinyml-traffic-classifier-counter-esp32s3"
